...
const GeoLayout Test_area_1_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, -1471, 80, -37, Test_dl_Cube_mesh_layer_1),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, 28, 17, -37, Test_dl_Cylinder_mesh_layer_1),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
